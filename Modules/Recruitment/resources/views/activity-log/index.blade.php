    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-semibold text-gray-900">
                                        {{ $activities->where('action', 'login')->count() }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-semibold text-gray-900">
                                        {{ $activities->whereIn('action', ['exam_started', 'exam_submitted'])->count() }}
                                    </dd>
                                </dl>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-semibold text-gray-900">
                                        {{ $activities->where('created_at', '>=', now()->startOfDay())->count() }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                {{-- <x-activity-log-table :activities="$activities" /> --}}
                        ...
                        @forelse($activities->groupBy(function($activity) {
                            ...
                            <div class="activity-group">
                                <div class="sticky top-0 bg-gray-50 px-6 py-2 border-b border-gray-200">
                                    <h3 class="text-sm font-medium text-gray-500">
                                        {{ \Carbon\Carbon::parse($date)->format('F j, Y') }}</h3>
                                </div>
                                        ...
                                        <div class="flex items-start space-x-4">
                                                ...
                                                <div
                                                    ...
                                                    {{ $activity->action === 'login'
                                                        ...
                                                        : ($activity->action === 'logout'
                                                            ...
                                                            : ($activity->action === 'exam_started'
                                                                ? 'bg-blue-100 text-blue-600'
                                                                : ($activity->action === 'exam_submitted'
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <div class="mt-2 text-sm text-gray-600">
                                                    <p><span class="font-medium">User Agent:</span>
                                                        {{ $activity->properties['user_agent'] ?? 'N/A' }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            @empty
                                <div class="p-6 text-center text-gray-500">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">Get started by performing some actions in the system.
                                    </p>
                                </div>
                            @endforelse
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
                ...
                searchInput.addEventListener('input', function(e) {
                    ...
                    searchTimeout = setTimeout(() => {
                        ...
                        activityGroups.forEach(group => {
                            ...
                            group.style.display = visibleItems.length > 0 ? 'block' :
                            'none';
                        });
            ...
            window.exportActivities = function() {
                ...
                const rows = Array.from(activityItems).map(item => {
                    ...
                    const ip = item.querySelector('.text-sm.text-gray-500:last-child').textContent
                        .replace('IP: ', '');
