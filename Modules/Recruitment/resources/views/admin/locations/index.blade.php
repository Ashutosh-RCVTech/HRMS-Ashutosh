                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-slate-800 dark:divide-gray-700">
                            @forelse ($locations as $location)
                                <tr class="hover:bg-gray-400 dark:hover:bg-gray-700 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-900 dark:text-white">{{ $location->name }}</td>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            searchForm.addEventListener('submit', function(e) {
                ...
                if (searchValue) {
                    window.location.href = `{{ route('admin.locations.index') }}?search=${encodeURIComponent(searchValue)}`;
                } else {
