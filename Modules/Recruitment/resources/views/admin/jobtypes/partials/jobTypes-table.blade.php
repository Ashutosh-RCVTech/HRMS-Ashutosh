@forelse ($jobTypes as $jobType)
    <tr class="border-b hover:bg-gray-400 dark:hover:bg-gray-700 transition-colors">
        ...
        <td class="px-6 py-4 text-sm text-gray-900 dark:text-white">{{ $jobType->name }}</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
            <div class="flex gap-2">
                <a href="{{ route('admin.jobTypes.edit', $jobType->id) }}"
                ...
                <button onclick="deleteJobType({{ $jobType->id }})"
