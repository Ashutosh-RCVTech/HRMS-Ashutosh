    ...
    <main class="w-full px-6 pb-6 pt-24 dark:bg-slate-900 dark:text-white">
        <div class="container mx-auto px-4 py-8">
            <div class="p-6 bg-white border-b border-gray-200 dark:bg-slate-900 dark:text-white">
                ...
                <form id="client_edit_form" method="POST" action="{{ route('admin.clients.update', $client->id) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select id="company_type" name="company_type" required
                                    ...
                                    <option value="corporation"
                                        {{ old('company_type', $client->company_type) == 'corporation' ? 'selected' : '' }}>
                                        Corporation</option>
                                    <option value="partnership"
                                        {{ old('company_type', $client->company_type) == 'partnership' ? 'selected' : '' }}>
                                        Partnership</option>
                                    <option value="sole_proprietorship"
                                        {{ old('company_type', $client->company_type) == 'sole_proprietorship' ? 'selected' : '' }}>
                                        Sole Proprietorship</option>
                                    <option value="llc"
                                        {{ old('company_type', $client->company_type) == 'llc' ? 'selected' : '' }}>LLC
                                    </option>
                                </select>
                                @error('company_type')
                                    <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                            ...
                            <!-- Industry -->
                            <div>
                                <label for="industry" class="block text-sm font-medium text-gray-700 mb-2 dark:text-white">
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-slate-800 dark:text-white dark:border-gray-700"
                                    rows="3" placeholder="Enter company description">{{ old('description', $client->description) }}</textarea>
                                @error('description')
                                    <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input id="contact_person_position" name="contact_person_position" type="text"
                                    value="{{ old('contact_person_position', $client->contact_person_position) }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-slate-800 dark:text-white dark:border-gray-700"
                                    placeholder="Manager">
                            ...
                            <div>
                                ...
                                <textarea id="address" name="address"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-slate-800 dark:text-white dark:border-gray-700"
                                    rows="2" placeholder="Enter address">{{ old('address', $client->address) }}</textarea>
                                @error('address')
                                    <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select id="subscription_tier" name="subscription_tier" required
                                    ...
                                    <option value="1"
                                        {{ old('subscription_tier', $client->subscription_tier) == '1' ? 'selected' : '' }}>
                                        Basic</option>
                                    <option value="2"
                                        {{ old('subscription_tier', $client->subscription_tier) == '2' ? 'selected' : '' }}>
                                        Premium</option>
                                    <option value="3"
                                        {{ old('subscription_tier', $client->subscription_tier) == '3' ? 'selected' : '' }}>
                                        Enterprise</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input id="subscription_expiry" name="subscription_expiry" type="date"
                                    value="{{ old('subscription_expiry', $client->subscription_expiry ? date('Y-m-d', strtotime($client->subscription_expiry)) : '') }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-slate-800 dark:text-white dark:border-gray-700">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                @if ($client->client_logo_path)
                                    <div class="mt-4">
                                        <img src="{{ Storage::url($client->client_logo_path) }}" alt="Client Logo"
                            ...
                            <div>
                                ...
                                @if ($client->banner_image_path)
                                    <div class="mt-4">
                                        <img src="{{ Storage::url($client->banner_image_path) }}" alt="Banner Image"
