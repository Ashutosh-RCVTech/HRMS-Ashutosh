            ...
            <div class="container mx-auto px-4 py-8">
                <div class="p-6 bg-white border-b border-gray-200 dark:bg-slate-900 dark:text-white">
                    ...
                    <div class="flex justify-between items-center mb-8">
                        <h1 class="text-2xl font-bold">Quiz Courses</h1>
                        <a href="{{ route('admin.quiz.courses.create') }}"
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-slate-800 dark:divide-gray-700">
                                @forelse ($courses as $course)
                                    <tr class="hover:bg-gray-400 dark:hover:bg-gray-700 transition-colors">
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-900 dark:text-white">{{ $course->name }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                <a href="{{ route('admin.quiz.courses.edit', $course) }}"
                                                ...
                                                <a href="{{ route('admin.quiz.quizes.index', $course->id) }}"
                                                ...
                                                <form action="{{ route('admin.quiz.courses.destroy', $course) }}"
