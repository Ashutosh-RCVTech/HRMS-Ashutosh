...
@section('title', 'Quiz Assignments')

@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Quiz Assignments: {{ $quiz->name }}</h1>
            <a href="{{ route('admin.quiz.assignments.create', $quiz->id) }}"
                class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">
                Assign Quiz to Candidates
            </a>
        </div>
                        ...
                        @forelse($assignments as $assignment)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    ...
                                    <form
                                        action="{{ route('admin.quiz.assignments.destroy', [$quiz->id, $assignment->id]) }}"
