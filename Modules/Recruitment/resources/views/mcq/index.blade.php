...
@section('content')
    ...
    <!-- Scripts -->
    {{-- {{ dd($examDuration, $warningCount, $totalQuestions, $remainingTime) }}
    <x-mcq-scripts :totalQuestions="$totalQuestions" :examDuration="$examDuration" :remainingTime="$remainingTime"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateNavigationButtons() {
                ...
                if (nextBtn.disabled) {
                    nextBtn.classList.add('bg-gray-100', 'text-gray-700', 'hover:bg-gray-200');
                    nextBtn.classList.remove('bg-blue-600', 'text-white', 'hover:bg-blue-700');
                    prevBtn.classList.remove('bg-gray-100', 'text-gray-700', 'hover:bg-gray-200');
                    ...
                    nextBtn.classList.remove('bg-gray-100', 'text-gray-700', 'hover:bg-gray-200');
                    prevBtn.classList.remove('bg-blue-600', 'text-white', 'hover:bg-blue-700');
                    prevBtn.classList.add('bg-gray-100', 'text-gray-700', 'hover:bg-gray-200');
            ...
            const thanksUrl = "{{ route('candidate.mcq.thanks') }}";
