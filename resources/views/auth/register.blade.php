            ...
            <div class="lg:w-1/2 px-5 xl:pl-12 pt-10">
                <header>
                    <a href="index.html" class="">
                        <img src="https://www.rcvtechnologies.com/wp-content/uploads/2024/03/2-removebg-preview.png"
                            class="block dark:hidden h-12 w-18" alt="Logo" />
                        <img src="https://www.rcvtechnologies.com/wp-content/uploads/2024/03/2-removebg-preview.png"
                            class="hidden dark:block" alt="Logo" />
                    </a>
                </header>
                ...
                <div class="max-w-[460px] m-auto pt-24 pb-16">
                    ...
                    <div class="relative mt-6 mb-5">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="bg-white dark:bg-slate-900 px-2 text-base text-bgray-600">Or continue
                                with</span>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div class="w-full">
                                <input type="text" name="name" :value="old('name')"
                                    class="text-bgray-800 dark:text-white dark:bg-slate-900 dark:border-darkblack-400 text-base border border-bgray-300 h-14 w-full focus:border-success-300 focus:ring-0 rounded-lg px-4 py-3.5 placeholder:text-bgray-500 placeholder:text-base"
                        ...
                        <div class="flex items-start mb-7">
                            <input type="checkbox" id="remember"
                                ...
                                name="terms" />
                            <label for="remember" class="ml-3 text-bgray-600 dark:text-white text-base">
                                By creating an account, you agree to our
                                <span class="text-bgray-900 dark:text-white">Privacy Policy</span> and
                                <span class="text-bgray-900 dark:text-white">Electronics Communication Policy</span>.
                            </label>
                        </div>
                    ...
                    <!-- Form Bottom -->
                    <p class="text-center text-bgray-900 dark:text-white text-base font-medium pt-7">
                        Already have an account? <a href="{{ route('login') }}" class="font-semibold underline">Log
                            In</a>
                    </p>
                    ...
                    <p class="text-bgray-600 dark:text-darkblack-300 text-center text-sm mt-6">
                        &copy; @ 2024 RCV Technologies All Right Reserved.
                    </p>
                </div>
            </div>
            <!-- Right -->
